...
// List of Guests from exercise 16

let guestArr : string [] = [ 'Jannat', 'Namra', 'Maha', 'Maryam', 'Naheed', 'Iqra' ]


console.log("Due to some inconvenience , I can invite only two people for Dinner"); 
